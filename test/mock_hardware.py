...
class MockGeneratorDriver:
    ...
    def create_vz_gate_definition_word(self, phase_rad):
        return 99999

    def write_readout_wave(self, wdw):
        return 0
    ...
    def set_drive_order_source(self, src):
        return 0

    def add_wave_to_drive_wave_sequence(self, idx, wave_id):
        return 0

    def set_drive_dds_parameters(self, frequency, dac_samplerate):
        return 0

    def set_readout_dds_parameters(self, frequency, phase, dac_samplerate):
        return 0
...
class MockAcquisitionDriver:
    ...
    def set_time_of_flight(self, tof):
        return 0

    def set_decimated_output_type(self, mode):
        return 0
...
class MockTriggerDriver:
    ...
    def set_experiment_duration(self, dur):
        return 0

    def set_readout_delay(self, delay, ch):
        return 0

    def insert_drive_delay(self, ch, idx, delay, gen):
        return 0
...
class MockOverlay:
    ...
    def configure_dac_mix_mode(self, *args, **kwargs):
        return {"changed": False}

    def configure_adc_mix_mode(self, *args, **kwargs):
        return {"changed": False}
