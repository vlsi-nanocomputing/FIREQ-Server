...
class TestRobustness:
    ...
    def test_zipped_sweep_topology(self, stack):
        ...
        **Rationale:**
        ...
        msg = {
            "sweep_id": "diag_test",
            "sweep_mode": "zipped",
            "base": {"generators": [{"gen_index": 0, "drive": {"frequency_mhz": "$f", "gain": "$g"}}]},
    ...
    def test_trigger_delay_propagation(self, stack):
        ...
        **Rationale:**
        ...
        """
        config = {
            "trigger": {"drive": True, "readout": False, "drive_start_index": 10, "safe_pad": 5, "shot_duration": 1000},
            "generators": [],
            "acquisitions": [],
        }
        ...
        stack.adapter.tg_program_delays.assert_called_with(drive=True, readout=False, drive_start_index=10, safe_pad=5)
